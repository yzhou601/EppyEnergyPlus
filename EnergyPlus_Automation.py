...
for i in weatherfilename_list:
    ...
    #Path to store the final IDF file
    RemoveIdealPart(LocationIDF, autofileIdealDir, fname2)
    #Remove ideal load air system part in location updated IDF file, and write a new IDF file without system to path "fname2"
    AddHvacPart(fname2, HVACIDF_Dir)
    #add HVAC blocks to this fname2 IDF file
